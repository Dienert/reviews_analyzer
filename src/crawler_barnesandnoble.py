...
class BarnesandnobleSpider(scrapy.Spider):
    ...
    page = 0
    totalPages = None
    url = 'https://api.bazaarvoice.com/data/batch.json?passkey=caC2Xb0kazery1Vgcza74qqETLsDbclQWr3kbWiGXSvjI&apiversion=5.5&displaycode=19386_1_0-en_us&resource.q1=reviews&filter.q1=productid:eq:9780316017930&filter.q1=contentlocale:eq:en_US&sort.q1=isfeatured:desc&stats.q1=reviews&filteredstats.q1=reviews&include.q1=authors&filter_reviews.q1=contentlocale:eq:en_US&filter_reviewcomments.q1=contentlocale:eq:en_US&filter_comments.q1=contentlocale:eq:en_US&limit.q1={}&offset.q1={}&callback=BV._internal.dataHandler0'
    start_urls = [url.format(limit, offset)]
    ...
    def parse(self, response):
        ...
        if self.page < self.totalPages:
            ...
            self.page += 1            
            yield response.follow(self.url.format(self.limit, self.offset))
